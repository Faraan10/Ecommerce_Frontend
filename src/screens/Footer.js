  ...
  return (
    <div className="bodyimg">
      <div className="footerdiv">
        <img
          className="footerimg"
          src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/PlayStation_logo_and_wordmark.svg/1200px-PlayStation_logo_and_wordmark.svg.png"
          alt="footerimg"
        />
        <br />
      ...
      <div className="foooterdiv3">
        <img
          src="https://vgboxart.com/resources/logo/5525_sony-computer-entertainment-prev.png"
          alt="interavtiveEntertainmentlogo"
        ...
        <p className="footercontentcopyright">
          ...
          <p className="footercontentrights">
            ...
            trademarks, artworks and associated imagery and
